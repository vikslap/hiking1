...
export default function PlanPage() {
  return (
    <div className="min-h-screen bg-white font-public text-gray-800 px-4 py-6 flex flex-col items-center">
      {/* Heading */}
      ...
      <div className="flex flex-col gap-6 md:flex-row md:gap-4 md:justify-center md:items-start w-full max-w-6xl">
        {/* Solo Hike */}
        <div className="flex-1 max-w-sm mx-auto md:mx-0 rounded-lg overflow-hidden shadow-md">
